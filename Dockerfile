...
RUN apt-get -qq update && DEBIAN_FRONTEND=noninteractive apt-get -y -qq install php-mysql php-apcu php-fpm php-curl php-gd php-intl php-pear php-imap php-memcache memcached mc mysql-client
